...
public data class SeniorCustomer(
    val firstName: kotlin.String,
    val middleName: kotlin.String?,
    val lastName: kotlin.String,
    val age: java.math.BigInteger,
) {
    init {
    }
...
if (age == null) {
    ...
    var age: java.math.BigInteger? = null
    fun withAge(age: java.math.BigInteger) = apply {
        this.age = age
    }
    fun build() = SeniorCustomer(
    ...
    age = this.age ?: throw IllegalArgumentException("age cannot be null"),
    )
}
}
